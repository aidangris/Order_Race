      ...
      while (true){
        ...
        if (gm == 'PHD'){
          switch (length){
            ...
            case '2': result = '0x'; for (let i = 0; i < 5; i ++){ result += hex.charAt(Math.floor(Math.random() * hex.length)); } break;
            case '3': result = this.romanize(Math.floor(Math.random() * 20) + 1); break;
            case '4':
